...
class LangItalian(object):
    ...
    SETTING_SAVE_COVERS = "Salvare copertine"
    SETTING_LANGUAGE = "Lingua"
    SETTING_USE_PLAYLIST_FOLDER = "Utilizza cartella playlist"
    SETTING_MULITHREAD_DOWNLOAD = "Download multiplo"
    SETTING_ALBUM_FOLDER_FORMAT = "Formato cartella album"
    SETTING_TRACK_FILE_FORMAT = "Formato file traccia"
    SETTING_SHOW_PROGRESS = "Mostra percentuale download"
    SETTING_SAVE_ALBUMINFO = "Salvare AlbumInfo.txt"
    ...
    CHOICE_EXIT = "Uscita"
    CHOICE_LOGIN = "Verifica AccessToken"
    ...
    CHANGE_SAVE_COVERS = "Salva copertine ('0'-No,'1'-Sì):"
    ...
    MSG_VALID_ACCESSTOKEN = "AccessToken valido per {}."
    MSG_INVAILD_ACCESSTOKEN = "AccessToken scaduto. Tentativo di refresh in corso."
